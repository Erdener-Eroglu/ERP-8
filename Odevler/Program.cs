...
do
{
    string secimEkranı = $"1) Sayı Tahmin Oyunu\n2) Zar Tahmin Oyunu\n3) Sayıyı Metne Çevir\n4) Çıkış";
    Console.WriteLine(secimEkranı);
    ...
    do
    {
        ...
        try
        {
            ...
            if (tahminEdilenSayi < 0 || tahminEdilenSayi > 100)
                throw new Exception("0-100 arasu bir sayı giriniz.");
            ...
            {
                Console.WriteLine($"Tebrikleri {tahminSayisi}. denemede doğru tahmin ettiniz.");
                break;
            }
        }
        catch
...
void ZarTahminOyunu()
{
    ...
    do // Oyun döngüsü
    {
        ...
        {
            Console.WriteLine($"Tebrikler, {tahminSayisi}. denemede istenen zar bulundu.");
            break;
        }
...
int SayiGirdirici(int baslangic, int bitis, string mesaj, string hataMesajı = "Yanlış giriş yaptınız.")
{
    do // Doğru sayı girene kadar döngü.
    {
        Console.Write(mesaj);
        try
        {
